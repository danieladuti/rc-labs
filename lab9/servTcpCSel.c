  ...
  while (1)
    {
      ...
      for (fd = 0; fd <= nfds; fd++)	/* parcurgem multimea de descriptori */ //parcurgem si descriptorul acceptului de asta fd porneste de la 0(daca nu ar porni de la 0 nu am putea accesa si fd_accept)
      {
